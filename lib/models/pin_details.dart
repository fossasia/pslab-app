...
class PinDetails {
  ...
  static List<PinDetails> getAllPins(BuildContext context) {
    ...
    return [
      ...
      PinDetails(l10n.pin_down_name, l10n.pin_down_desc, const Color(0xFF707070)),
      ...
      PinDetails(l10n.pin_cap_name, l10n.pin_cap_desc, const Color(0xFFB380FFB380FF)),
