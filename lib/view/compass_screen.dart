                    ...
                    child: Center(
                      child: Transform.rotate(
                        ...
                        child: Container(
                          ...
                          child: Image.asset(compassIcon, fit: BoxFit.contain),
                        ),
                      ),
                    ),
                  ),
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            _buildAxisColumn(
                              'Bx',
                              compassProvider.magnetometerEvent.x,
                            ),
                            _buildAxisColumn(
                              'By',
                              compassProvider.magnetometerEvent.y,
                            ),
                            _buildAxisColumn(
                              'Bz',
                              compassProvider.magnetometerEvent.z,
                            ),
                          ],
                        ),
                        const SizedBox(height: 24),
