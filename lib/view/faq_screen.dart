...
class FAQScreen extends StatelessWidget {
  static const List<FAQItem> faqs = [
     ...
     FAQItem(
      question: "How can I connect to the device? What kind of USB cable do I need? What is an OTG USB cable?",
     ...
     FAQItem(
      question: "I found a bug in one of your apps or hardware. What to do? Where should I report it?",
      answer: "We have issue trackers in all our projects. They are currently hosted on GitHub. In order to submit a bug or feature request you need to login to the service.",
      linkText: "A list of our PSLab repositories is here",
      linkUrl: "https://github.com/fossasia"
    ),
     FAQItem(
      question: "Can I record or save data in the apps and export or import it?",
